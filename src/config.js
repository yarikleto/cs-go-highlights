 ...
 *
 * Demo-batch protection (all demos in a run must share the same
 * networkProtocol) is enforced inside assertVersionCompatibility without
 * needing a configured value here.
 */
